...
public class Sonuc extends AppCompatActivity {
        ...
        navigationView.setNavigationItemSelectedListener(new NavigationView.OnNavigationItemSelectedListener() {
            ...
            public boolean onNavigationItemSelected(@NonNull MenuItem menuItem) {
                if (menuItem.getItemId() == R.id.home) {
                    ...
                    startActivity(i);
                    finish();
                    Toast.makeText(Sonuc.this,R.string.anasayfa, Toast.LENGTH_SHORT).show();
                    drawerLayout.closeDrawer(GravityCompat.START);
                } else if (menuItem.getItemId() == R.id.kolay) {
                    Intent i = new Intent(Sonuc.this,Kolay.class);
                    startActivity(i);
                    finish();
                    Toast.makeText(Sonuc.this,R.string.kolay, Toast.LENGTH_SHORT).show();
                    drawerLayout.closeDrawer(GravityCompat.START);
                } else if (menuItem.getItemId() == R.id.orta) {
                    Intent i = new Intent(Sonuc.this,Orta.class);
                    startActivity(i);
                    finish();
                    Toast.makeText(Sonuc.this,R.string.orta, Toast.LENGTH_SHORT).show();
                    drawerLayout.closeDrawer(GravityCompat.START);
                } else if (menuItem.getItemId() == R.id.zor) {
                    Intent i = new Intent(Sonuc.this,Zor.class);
                    startActivity(i);
                    finish();
                    Toast.makeText(Sonuc.this,R.string.zor, Toast.LENGTH_SHORT).show();
                    drawerLayout.closeDrawer(GravityCompat.START);
                } else if (menuItem.getItemId() == R.id.menu_uygulama) {
                    Intent i = new Intent(Sonuc.this,Ugulamah.class);
                    startActivity(i);
                    finish();
                    Toast.makeText(Sonuc.this,R.string.uygulama_hakinda, Toast.LENGTH_SHORT).show();
                    drawerLayout.closeDrawer(GravityCompat.START);
                } else if (menuItem.getItemId() == R.id.menu_cikis) {
                    Toast.makeText(Sonuc.this,R.string.cikis, Toast.LENGTH_SHORT).show();
                    drawerLayout.closeDrawer(GravityCompat.START);
    ...
    public void sonuc(){
        ...
        algoster.setText(String.valueOf(goster));
        ...
        if (sonuc){
            ...
            textViewSonuc.setText(R.string.kazandin);
        }
        else {
            imageViewSonuc.setImageResource(R.drawable.dissatis);
            textViewSonuc.setText(R.string.kaybittin);
