        ...
        navigationView.setNavigationItemSelectedListener(new NavigationView.OnNavigationItemSelectedListener() {
            ...
            public boolean onNavigationItemSelected(@NonNull MenuItem menuItem) {
                if (menuItem.getItemId() == R.id.home) {
                    recreate();
                    Toast.makeText(MainActivity.this,R.string.anasayfa, Toast.LENGTH_SHORT).show();
                    ...
                    startActivity(i);
                    Toast.makeText(MainActivity.this,R.string.kolay, Toast.LENGTH_SHORT).show();
                    drawerLayout.closeDrawer(GravityCompat.START);
                }
                else if (menuItem.getItemId() == R.id.orta) {
                    Intent i = new Intent(MainActivity.this,Orta.class);
                    startActivity(i);
                    Toast.makeText(MainActivity.this,R.string.orta, Toast.LENGTH_SHORT).show();
                    drawerLayout.closeDrawer(GravityCompat.START);
                }
                else if (menuItem.getItemId() == R.id.zor) {
                    Intent i = new Intent(MainActivity.this,Zor.class);
                    startActivity(i);
                    Toast.makeText(MainActivity.this,R.string.zor, Toast.LENGTH_SHORT).show();
                    drawerLayout.closeDrawer(GravityCompat.START);
                }
                else if (menuItem.getItemId() == R.id.menu_uygulama) {
                    Intent i = new Intent(MainActivity.this,Ugulamah.class);
                    startActivity(i);
                    Toast.makeText(MainActivity.this,R.string.uygulama_hakinda, Toast.LENGTH_SHORT).show();
                    drawerLayout.closeDrawer(GravityCompat.START);
                }
                else if (menuItem.getItemId() == R.id.menu_cikis) {
                    Toast.makeText(MainActivity.this,R.string.cikis, Toast.LENGTH_SHORT).show();
                    drawerLayout.closeDrawer(GravityCompat.START);
        ...
        btn_asla.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (radio_kolay.isChecked()){
                    ...
                    Toast.makeText(MainActivity.this,R.string.birseviye, Toast.LENGTH_LONG).show();
                }
