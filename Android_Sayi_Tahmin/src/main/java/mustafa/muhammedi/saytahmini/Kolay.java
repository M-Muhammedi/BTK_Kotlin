        ...
        navigationView.setNavigationItemSelectedListener(new NavigationView.OnNavigationItemSelectedListener() {
            ...
            public boolean onNavigationItemSelected(@NonNull MenuItem menuItem) {
                if (menuItem.getItemId() == R.id.home) {
                    ...
                    startActivity(i);
                    finish();
                    Toast.makeText(Kolay.this, R.string.anasayfa, Toast.LENGTH_SHORT).show();
                    drawerLayout.closeDrawer(GravityCompat.START);
                }
                else if (menuItem.getItemId() == R.id.kolay) {
                    recreate();
                    Toast.makeText(Kolay.this,R.string.kolay, Toast.LENGTH_SHORT).show();
                    drawerLayout.closeDrawer(GravityCompat.START);
                }
                    ...
                    startActivity(i);
                    finish();
                    Toast.makeText(Kolay.this, R.string.orta, Toast.LENGTH_SHORT).show();
                    drawerLayout.closeDrawer(GravityCompat.START);
                }
                    ...
                    startActivity(i);
                    finish();
                    Toast.makeText(Kolay.this, R.string.zor, Toast.LENGTH_SHORT).show();
                    drawerLayout.closeDrawer(GravityCompat.START);
                }
                    ...
                    startActivity(i);
                    finish();
                    Toast.makeText(Kolay.this,R.string.uygulama_hakinda, Toast.LENGTH_SHORT).show();
                    drawerLayout.closeDrawer(GravityCompat.START);
                }
                else if (menuItem.getItemId() == R.id.menu_cikis) {
                    Toast.makeText(Kolay.this,R.string.cikis, Toast.LENGTH_SHORT).show();
                    drawerLayout.closeDrawer(GravityCompat.START);
            ...
            btn_tahmin.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    if (editTextGirdi.getText().toString().isEmpty()) {
                        ...
                        Toast.makeText(Kolay.this,R.string.birsayigir, Toast.LENGTH_SHORT).show();
