        ...
        navigationView.setNavigationItemSelectedListener(new NavigationView.OnNavigationItemSelectedListener() {
            ...
            public boolean onNavigationItemSelected(@NonNull MenuItem menuItem) {
                if (menuItem.getItemId() == R.id.home) {
                    ...
                    startActivity(i);
                    finish();
                    Toast.makeText(Ugulamah.this,R.string.anasayfa, Toast.LENGTH_SHORT).show();
                    drawerLayout.closeDrawer(GravityCompat.START);
                } else if (menuItem.getItemId() == R.id.kolay) {
                    Intent i = new Intent(Ugulamah.this,Kolay.class);
                    startActivity(i);
                    finish();
                    Toast.makeText(Ugulamah.this,R.string.kolay, Toast.LENGTH_SHORT).show();
                    drawerLayout.closeDrawer(GravityCompat.START);
                } else if (menuItem.getItemId() == R.id.orta) {
                    Intent i = new Intent(Ugulamah.this,Orta.class);
                    startActivity(i);
                    finish();
                    Toast.makeText(Ugulamah.this,R.string.orta, Toast.LENGTH_SHORT).show();
                    drawerLayout.closeDrawer(GravityCompat.START);
                } else if (menuItem.getItemId() == R.id.zor) {
                    Intent i = new Intent(Ugulamah.this,Zor.class);
                    startActivity(i);
                    finish();
                    Toast.makeText(Ugulamah.this,R.string.zor, Toast.LENGTH_SHORT).show();
                    drawerLayout.closeDrawer(GravityCompat.START);
                } else if (menuItem.getItemId() == R.id.menu_uygulama) {
                    Intent i = new Intent(Ugulamah.this,Ugulamah.class);
                    startActivity(i);
                    finish();
                    Toast.makeText(Ugulamah.this,R.string.uygulama_hakinda, Toast.LENGTH_SHORT).show();
                    recreate();
                    drawerLayout.closeDrawer(GravityCompat.START);
                } else if (menuItem.getItemId() == R.id.menu_cikis) {
                    Toast.makeText(Ugulamah.this,R.string.cikis, Toast.LENGTH_SHORT).show();
                    drawerLayout.closeDrawer(GravityCompat.START);
